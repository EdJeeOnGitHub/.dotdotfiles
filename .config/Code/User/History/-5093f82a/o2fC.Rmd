...
## Urban Kambar and Sujawal

```{r}
bind_rows(

urban_df %>%
    filter(district == "KAMBAR SHAHDAD KOT DISTRICT") %>%
    summarise( 
        across(
...
essentially drowned out in comparison to the variance of the standard errors 
across simulation draws.
