...
script_options <- docopt::docopt(
  ...
  estimate-att-gt.R [ --fake-data --time-aggregation-level=<time-aggregation-level>]
  Options:
  ...
  --num-bootstrap-draws
"),
  args = if (interactive()) "--fake-data --time-aggregation-level=week" else commandArgs(trailingOnly = TRUE)
) 
