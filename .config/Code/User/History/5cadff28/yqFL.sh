...
Rscript ./run_takeup.R sbc struct --num-mix-groups=1 --chains=1 --cores=1 --num-sbc-sims=1 --models=STRUCTURAL_LINEAR_U_SHOCKS --output-path=data/sbc_output_data --include-paths=stan_models --iter=2000  --outputname=test --multilevel " else commandArgs(trailingOnly = TRUE)
