...
\end{align}
    ...
    Finally, it's worth remembering that we wanted to tested a fact about multiple 
    properties of a distribution - in randomised control trials it often makes sense 
    to perform a balance test to check that covariates are "balanced" across treatment 
    and control. One way of doing this is a $\chi^2$ test to check for equality 
    of means across covariates in treatment and control.
