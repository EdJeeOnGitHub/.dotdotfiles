...
Borusyak and Hull (2022) wouldn't use continuous distance to POT but the difference between expected and realised distance to POT. Whilst 
...
This is essentially using the difference between the expected distance and realised distance as an instrument - since the actual treatment assignment was chosen randomly from a set of hypothetical draws, this variation is as good as random.