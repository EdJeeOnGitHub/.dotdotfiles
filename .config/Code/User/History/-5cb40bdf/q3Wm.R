...
anon_f = function(seed) {
    ...
    gen_data = meta_gen_data_function(N = 1000, J = 1)
...
data %>%
    ...
    geom_histogram() 
VGAM::rgompertz(100, shape = 1, scale = 1) 

gomp_model = cmdstan_model("stan/simple-gompertz.stan")
options(mc.cores = 4)
