...
# heckit_model = stan_model("stan/test.stan")

default_data_args = list(N = 100, p = 2, q = 2, cutoff_quantile = NA)
default_params_args = list(mu_beta = 0, sd_beta = 1)
default_modelled_data_args = list(selection_type = "conventional", rubin = FALSE)
