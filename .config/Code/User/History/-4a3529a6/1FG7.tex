...
\begin{frame}{EDE Magnitudes III}
    ...
    For a lab experiment with low stakes games these might be small.

    But even if in the field the impact is less than 1/10th as strong this would 
    be similar in magnitude to CCT programmes targeting test scores.
