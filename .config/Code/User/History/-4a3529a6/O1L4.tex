...
\begin{frame}{How bad are EDEs? II}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item “The researchers conducting this survey expect that individuals are more likely to choose a news story if it is offered by a news outlet with a reputation of being friendly towards their preferred political party. If your responses support this theory, you will receive a $0.25 bonus payment"
        \end{itemize}    
    \end{itemize}
