...
anon_function = function(MDEs) {
    linear_utility_function(rep(1/4, 4), MDEs)
} 


mde_utility(p_vector = rep(1/4, 4), N_total = 2250, utility_function = anon_function)



optim(
    par = rep(1/4, 4),
    fn = function(x){mde_utility(p_vector = x, N_total = 2250, utility_function = anon_function)}
)
