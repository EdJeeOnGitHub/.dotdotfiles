script_options <- docopt::docopt(
  ...
  --time-aggregation-level=<time-aggregation-level>  Level of time to aggregate to. [default: months]
"),
...
if (script_options$fake_data) {
    town_month_input_path = "data/output/fake-town-month-vaccination-data.csv"
    district_month_input_path = "data/output/fake-district-month-vaccination-data.csv"
} else {
...
if (script_options$fake_data) {
    town_vax_dt = town_vax_dt[vac_year_month > "2021-06-01" & vac_year_month < "2024-01-01"]
    district_vax_dt = district_vax_dt[vac_year_month > "2021-06-01" & vac_year_month < "2024-01-01"]
}
