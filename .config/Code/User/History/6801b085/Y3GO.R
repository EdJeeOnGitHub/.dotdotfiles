script_options <- docopt::docopt(
  ...
  scratch.R [ --fake-data --time-aggregation-level=<time-aggregation-level> --vaccine=<vaccine> --unit-aggregation-level=<unit-aggregation-level>]
...
"),
  args = if (interactive()) "--fake-data --time-aggregation-level=month --unit-aggregation-level=town  " else commandArgs(trailingOnly = TRUE)
) 
library(data.table)
library(tidyverse)
library(lubridate)
