...
\begin{enumerate}
    \item At $t=0$ henerate a prior, $Q_0$, over $\mu_k$, proceed to $t = 1$.
...
\end{enumerate}
    Thompson sampling can be analysed from a frequentist or Bayesian perspective
    and is often competitive with UCB.
