...
\begin{frame}{Problems In This Setting I}
    ...
    \begin{figure}[htbp]
        \centering
       \includegraphics[scale=0.2]{ramadan.png} 
...
\begin{frame}{Problems In This Setting II}
    ...
    \begin{figure}[htbp]
        \centering
       \includegraphics[scale=0.15]{tta-assignment.png} 
...
\begin{frame}{Problems In This Setting III}
   ...
   \begin{figure}[htbp]
       \centering
      \includegraphics[scale=0.15]{good-tta-assignment.png} 
   \end{figure} 
...
\begin{frame}{Happy RCT Participants?}
    ...
    \begin{figure}[htbp]
        \centering
       \includegraphics[scale=0.3]{welfare.png} 
    \end{figure}
