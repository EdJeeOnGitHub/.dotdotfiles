...
beta_raw = matrix(abs(rnorm(N_arms*J_outcomes)), nrow = N_arms, ncol = J_outcomes)
...
estimated_long_res %>%
    ...
    labs(
        ...
        y = "Proportion/MRS", 
        colour = "Arm/Outcome", 
        caption = paste0("Arm Welfare: ", paste(round(mu_bar, 3),  collapse = ", "))
    ) 

# ggsave(
#     "data/output/plots/hard-mab-example.png",
#     width = 8,
#     height = 6
# )
