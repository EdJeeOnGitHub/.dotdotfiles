...
array[num_clusters, num_age_groups] int<lower = 0> sim_cluster_takeup_count;
/*
################################################################################
...
if (fit_model_to_data) {
    ...
    if (use_binomial) {
        ...
        sim_cluster_takeup_count[included_clusters, 1] = binomial_rng(
            cluster_size[included_clusters, 1], 
            structural_cluster_takeup_prob[included_clusters]);
    } else {
