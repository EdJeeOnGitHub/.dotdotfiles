...
"),
  ...
  # args = if (interactive()) "sbc beliefs --chains=1 --cores=2 --num-sbc-sims=2 --output-path=data/sbc_output_data --include-paths=stan_models --iter=2000  --outputname=test --multilevel --age" else commandArgs(trailingOnly = TRUE)
