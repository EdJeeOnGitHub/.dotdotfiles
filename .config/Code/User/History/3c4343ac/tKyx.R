...
"),
  ...
  args = if (interactive()) "sbc wtp --chains=1 --cores=6 --num-sbc-sims=8 --output-path=data/sbc_output_data --include-paths=stan_models --iter=2000  --outputname=wtp_test --strata" else commandArgs(trailingOnly = TRUE)
