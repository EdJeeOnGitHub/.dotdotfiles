...
script_options <- docopt::docopt(
  ...
  run_takeup.R sbc bfs [--chains=<chains> --cores=<cores>  --iter=<iter> --outputname=<output file name>  --include-paths=<paths> --output-path=<path> --num-sbc-sims=<num-sbc-sims> --num-mix-groups=<num> --multilevel --age]
...
"),
  ...
  args = if (interactive()) "sbc rf --chains=1 --cores=2 --num-sbc-sims=2 --output-path=data/sbc_output_data --include-paths=stan_models --iter=2000  --outputname=test --multilevel --age" else commandArgs(trailingOnly = TRUE)
