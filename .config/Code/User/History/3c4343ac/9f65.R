...
script_options <- docopt::docopt(
  ...
  run_takeup.R sbc rf [ --sequential --chains=<chains> --threads=<threads> --iter=<iter> --thin=<thin> --force-iter --models=<models> --outputname=<output file name> --cmdstanr --include-paths=<paths> --output-path=<path> --num-mix-groups=<num> --multilevel --age --num-sbc-sims=<num-sbc-sims>]
