...
# Read in the data
raw_rural_df = read_xlsx("data/input/edited_Table_25_Final_Sindh_Urban_04 15 2022.xlsx", sheet = "Rural_original")
raw_urban_df = read_xlsx("data/input/edited_Table_25_Final_Sindh_Urban_04 15 2022.xlsx", sheet = "Urban_original")
...
write_csv(
    urban_df,
    "data/output/hh-survey/clean_urban_data.csv"
)

write_csv(
    rural_df,
    "data/output/hh-survey/clean_rural_data.csv"
)
