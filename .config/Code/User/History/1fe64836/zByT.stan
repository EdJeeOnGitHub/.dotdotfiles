...
hyper_beta_1ord[2:] = to_row_vector(normal_rng(rep_array(0, num_treatments - 1), 0.5));

hyper_dist_beta_1ord[1] = std_normal_rng();
hyper_dist_beta_1ord[2:] = to_row_vector(normal_rng(rep_array(0, num_treatments - 1), 0.5));
