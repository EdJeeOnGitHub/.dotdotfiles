...
# include_graphics( "../data/output/plots/fake-town-calendar-measles1-week-plot.png")
```
...
I don't have enough RAM to run daily estimates using my laptop unless I reduce 
the size of the dummy data significantly.
...
# Town Level Estimates (averaging across time)


```{r town-level-estim}

include_graphics(
    "../data/output/plots/fake-group-attgt-estimates-town-week-bcg-plot.png"
)
