...
default_stan_model = cmdstan_model("stan/hierarchical-rubin-selection-mvn.stan")
heckit_model = stan_model("stan/hier-vec.stan")
...
mod_fit = default_stan_model$sample(
    # default_stan_model,
    data = c(first_draw_data$data, first_draw_data$modelled_data)
)
vec_mod_fit = heckit_model$sample(
    # default_stan_model,
    data = c(first_draw_data$data, first_draw_data$modelled_data)
)
  stop()
