...
cmdstan_model("stan/selection-recentre.stan")
default_stan_model = stan_model("stan/selection-recentre.stan")
# heckit_model = cmdstan_model("stan/hier-vec.stan")

default_data_args = list(N = 60, p = 2, q = 2, d = 20, cutoff_quantile = 0.5)
default_params_args = list(mu_beta = 0, sd_beta = 1)
default_modelled_data_args = list(selection_type = "quantile", rubin = TRUE, selection_d = 2, recentre = TRUE)
