...
That is, $\hat{x}$ is the fitted value from the first stage (the second equation), 
...
parameter but rather $x$ has been "purged" of it's endogenous bits and only 
the parts explained by $Z$ which is independent of $\varepsilon$ - the "good" bits - remain.
\end{document}