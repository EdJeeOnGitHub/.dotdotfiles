...
for(s in 1:S){
  ...
  bayes_too_big_95 <- which(stan_fit_simple_table[c("b2[2]"), "2.5%"] > b2[2])
  bayes_too_small_95 <- which(stan_fit_simple_table[c("b2[2]"), "97.5%"] > b2[2])
  bayes_too_big_50 <- which(stan_fit_simple_table[c("b2[2]"), "25%"] > b2[2])
  bayes_too_small_50 <- which(stan_fit_simple_table[c("b2[2]"), "75%"] > b2[2])
