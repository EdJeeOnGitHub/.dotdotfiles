...
d <- 3 #governs dimension of X matrix in toto 
...
for(s in 1:S){
  ...
  # bayes_too_big_95 <- which(stan_fit_simple_table[c("b1[2]"), "2.5%"] > b1[2])
  # bayes_too_small_95 <- which(stan_fit_simple_table[c("b1[2]"), "97.5%"] > b1[2])
  # bayes_too_big_50 <- which(stan_fit_simple_table[c("b1[2]"), "25%"] > b1[2])
  # bayes_too_small_50 <- which(stan_fit_simple_table[c("b1[2]"), "75%"] > b1[2])
...
params_of_interest
colnames(calibration_50) = params_of_interest
colnames(calibration_95) = params_of_interest
