...
town_month_dt = create_aggregrate_data(
    long_dt,
    town_treatment_dt,
...
town_week_dt = create_aggregrate_data(
    long_dt,
    town_treatment_dt,
    unit_aggregation_level = c("district", "town"), 
...
town_day_dt = create_aggregrate_data(
    long_dt,
    town_treatment_dt,
    unit_aggregation_level = c("district", "town"), 
...
district_month_dt = create_aggregrate_data(
    long_dt, 
    town_treatment_dt,
