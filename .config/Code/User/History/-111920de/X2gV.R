...
create_aggregrate_data = function(data, 
    ...
    empty_panel_df[, 
        `:=`(town_treat_year_month = floor_date(town_roll_in_date_randomised, time_aggregation_level), 
        district_treat_year_month = floor_date(district_roll_in_date, time_aggregation_level))
    ]
    long_treat_dt[, date := floor_date(vac_date, time_aggregation_level)]
    collapsed_dt = long_treat_dt[, 
