...
\begin{align*}
    Pr(Y = y, D = d) &=  Pr(Y = y | Pr(D = d) = p_d) \times Pr(Pr(D = d) = p_d)\\
    &= Pr(\beta X + C_i^+\delta + \varepsilon_1 > 0 | Pr(D = d) = p_d) \times ... \\
    &\neq Pr(\beta X + C_i^+ \delta + \gamma p_d + \varepsilon_1 > 0 | Pr(D =  d) = p_d) \times ...
\end{align*}
In fact, we know that:
\begin{align*}
    Pr(Y = y, D = d) &=  Pr(Y = y | Pr(D = d) = p_d) \times Pr(Pr(D = d) = p_d)\\
    &= Pr(\beta X + C_i^+\delta + \varepsilon_1 > 0 | Pr(D = d) = p_d) \times ... \\
    &= Pr(\beta X + C_i^+\delta + \varepsilon_1 > 0 | Pr(C_i \gamma + \varepsilon_2 = d) = p_d) \times ... \\
\end{align*}
