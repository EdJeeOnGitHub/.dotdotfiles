...
Next, forget about likelihoods and start with what we want to know:
\begin{align*}
...
that if you integrate enough things by parts the same will be true here.

If we compare this to the likelihood presented originally it's clear that we need 
to do more than just stick in the propensity score to the link function. In fact, 
