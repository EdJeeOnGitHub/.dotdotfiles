...
\begin{align*}
    Pr(Y = y, X = x) &=  Pr(Y = y | Pr(X = 1) = p_x) \times Pr(Pr(X = 1) = p_x) + ...\\
    &= Pr(\beta X + C_i^+\delta + \varepsilon_1 > 0 | Pr(X = 1) = p_x) \times ...  + ...\\
    &\neq Pr(\beta X + C_i^+ \delta + \gamma p_x + \varepsilon_1 > 0 | Pr(X =  1) = p_x) \times ... + ...
\end{align*}
