...
effects. The algorithm estimates the welfare optimal treatment arm using preferences 
of subjects in an adaptive field 
experiment and not the experimenter's own preferences. In contrast to \cite{lin2022preference}, I design an incentive 
